...
T1 scaffold & toolchain complete; T2 domain types & curve engine complete; T3 config loader complete; T4 IPMI client complete — CI gates (pre-commit, pytest) green.
